...
public class AppViewManager {
    ...
    public static final AppView SETTINGS_VIEW = view("Settings", SettingsPresenter.class, MaterialDesignIcon.DASHBOARD, SHOW_IN_DRAWER);
    ...
    public static void registerViewsAndDrawer(MobileApplication app) {
        ...
        NavigationDrawer.Header header = new NavigationDrawer.Header("Gluon Mobile",
                "Multi View Project",
                new Avatar(21, new Image(VWMobileApp.class.getResourceAsStream("/icon.png"))));
